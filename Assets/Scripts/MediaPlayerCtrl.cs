...
public class MediaPlayerCtrl : MonoBehaviour {
	...
	void Update()
	{
		...
		if(m_bFirst == false)
		{
			...
			switch (num) {
				case 0:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/0/week0_360_TB.mp4";
					break;
				case 1:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/0/yale/week0_360_TB.mp4";
					break;
				case 2:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/1/week1_360_TB.mp4";
					break;
				case 3:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/2/week2_360_TB.mp4";
					break;
				case 4:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/3/week3_360_TB.mp4";
					break;
				case 5:
					sd_path = "http://cdn.cs50.net/2016/fall/lectures/4/week4_360_TB.mp4";
					break;
			}
			Debug.Log("path is " + sd_path);
